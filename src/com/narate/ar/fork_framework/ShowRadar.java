 ...
 */
public class ShowRadar extends SensorsActivity implements
		OnTouchListener {
	private static final String TAG = "ShowRadar";
	private static final DecimalFormat FORMAT = new DecimalFormat("#.##");

	private static WakeLock wakeLock = null;	
	private static SeekBar myZoomBar = null;
	private static FrameLayout frameLayout = null;
	private static RadarView augmentedView = null;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		FrameLayout.LayoutParams frameLayoutParams = new FrameLayout.LayoutParams(
				...
				Gravity.BOTTOM);
		frameLayoutParams.setMargins(20, 0, 20, 50);		
		addContentView(frameLayout, frameLayoutParams);

		augmentedView = new RadarView(this, useCollisionDetection);
	...
	protected void markerTouched(Marker marker) {
		Toast.makeText(this, "markerTouched()", Toast.LENGTH_LONG).show();
